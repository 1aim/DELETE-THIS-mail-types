...
use common::encoder::{EncodableInHeader, Encoder, Encodable};
...
impl EncodableMail {
        ...
        -> Result<Self, MailError>
    {
        ...
        if !mail.headers.contains(_From) {
            return Err(HeaderValidationError::BuildIn(BuildInValidationError::NoFrom));
        }
...
impl Encodable<Resource> for EncodableMail {
    ...
    fn encode(&self, encoder:  &mut Encoder<Resource>) -> Result<(), EncodingError> {
